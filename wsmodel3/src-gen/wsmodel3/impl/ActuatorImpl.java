 ...
 * </p>
 * <ul>
 *   <li>{@link wsmodel3.impl.ActuatorImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActuatorImpl extends DeviceImpl implements Actuator {
	 ...
	 * @ordered
	 */
	protected static final ActuatorType TYPE_EDEFAULT = ActuatorType.UNDEFINED;
	...
	protected EClass eStaticClass() {
		return Wsmodel3Package.Literals.ACTUATOR;
	}
	...
	public void setType(ActuatorType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wsmodel3Package.ACTUATOR__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Wsmodel3Package.ACTUATOR__TYPE:
			return getType();
		}
