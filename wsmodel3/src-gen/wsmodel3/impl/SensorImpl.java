 ...
 * </p>
 * <ul>
 *   <li>{@link wsmodel3.impl.SensorImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SensorImpl extends DeviceImpl implements Sensor {
	 ...
	 * @ordered
	 */
	protected static final SensorType TYPE_EDEFAULT = SensorType.UNDEFINED;
	...
	protected EClass eStaticClass() {
		return Wsmodel3Package.Literals.SENSOR;
	}
	...
	public void setType(SensorType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Wsmodel3Package.SENSOR__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Wsmodel3Package.SENSOR__TYPE:
			return getType();
		}
