...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/ws31acceleo/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(wsmodel3.Wsmodel3Package.class)) {
            resourceSet.getPackageRegistry().put(wsmodel3.Wsmodel3Package.eINSTANCE.getNsURI(), wsmodel3.Wsmodel3Package.eINSTANCE);
        }
